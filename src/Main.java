...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        BST_class bstSequntialOne = new BST_class(); //Example 1 test. Tests inserts, removes, invariant checker
        ...
        System.out.println("Sequential Test 2"); //tests inserts, removes, invariant checker, search
        ...
        System.out.println("Concurrent Test 1"); //tests concurrent insert, remove, invariant checker
...
//                System.out.println("Bye from Thread 11");
        ...
        System.out.println("\n" + "This is a "+ bstMulti.invariantChecker() + " BST");
        System.out.println("********************************************************************");
        System.out.println("Concurrent Test 2"); //tests concurrent insert, remove, search, invariant checker
        ...
        System.out.println("*******************************************************************");
        System.out.println("Concurrent Test 3"); //starts and joins all the threads together to check insert, remove and invariant checker
